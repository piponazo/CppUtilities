...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testapp _outputname)
   ...
   ADD_CUSTOM_TARGET(${_targetname}
      ...
      # Perform tests
      COMMAND echo ${_testapp} ${ARGV3} ${ARGV4} ${ARGV5} ${ARGV6} ${ARGV7}
      COMMAND ${_testapp} ${ARGV3} ${ARGV4} ${ARGV5} ${ARGV6} ${ARGV7}
      ...
      COMMAND ${LCOV_PATH} --remove total.info '${PROJECT_BINARY_DIR}/*' '/usr/*' 'tests/*'
         'utils/*' 'utilsTests/*' '/opt/*' -o total.info.cleaned

      # Generate report
      COMMAND ${GENHTML_PATH} -o ${_outputname} total.info.cleaned
